# Newt
An open source minimal web browser, built for a safer, cleaner, and faster experience surfing.

**Currently under development.**

## About Newt
**Newt is a web browser that allows you to search the web knowing safety features are in place.**
